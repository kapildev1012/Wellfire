      ...
      >
        ...
        >
          ...
          <motion.ul
            ...
            viewport={{ once: true }}
            className="grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-4 text-xs sm:text-sm text-gray-600 mt-6"
          >
            <li className="flex items-center gap-2">
              <div className="w-1.5 h-1.5 bg-black rounded-full flex-shrink-0"></div>
              <span className="font-medium text-xs sm:text-sm">High-Quality Products</span>
            </li>
            <li className="flex items-center gap-2">
              <div className="w-1.5 h-1.5 bg-black rounded-full flex-shrink-0"></div>
              <span className="font-medium text-xs sm:text-sm">Unique Experience</span>
            </li>
            <li className="flex items-center gap-2">
              <div className="w-1.5 h-1.5 bg-black rounded-full flex-shrink-0"></div>
              <span className="font-medium text-xs sm:text-sm">Trust & Satisfaction</span>
            </li>
          </motion.ul>
        </motion.div>
      </motion.div>
