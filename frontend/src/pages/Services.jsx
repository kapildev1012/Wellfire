...
const Services = () => {
  ...
  return (
    <section className="bg-gray-50 px-4 md:px-12 lg:px-20 py-12 md:py-16">
      <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-8 md:gap-10">
        {/* Left Intro */}
        <div>
          <h2 
            className="text-2xl sm:text-3xl font-bold mb-5 uppercase"
            style={{
              fontFamily: "Montserrat, sans-serif",
              fontWeight: "800",
            }}
        ...
        <div className="md:col-span-3 grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          <ServiceCard
            product={latest.film}
            title="Films"
            target="films"
